...
(function (Pcb) {
    ...
    })(LayerType = Pcb.LayerType || (Pcb.LayerType = {}));
    class Layer {
    ...
    Pcb.BoardDesignSetting = BoardDesignSetting;
    let ViaType;
    (function (ViaType) {
    ...
    })(ViaType = Pcb.ViaType || (Pcb.ViaType = {}));
    class NetClasses {
        constructor() {
            this.netClasses = {};
        }
    ...
    Pcb.NetClasses = NetClasses;
    class NetClass {
        constructor(name = "") {
            this.members = [];
        }
    }
    Pcb.NetClass = NetClass;
    class BoardItem {
        constructor() {
    ...
    })(PadShape = Pcb.PadShape || (Pcb.PadShape = {}));
    ;
    let PadAttr;
    (function (PadAttr) {
    ...
    })(PadAttr = Pcb.PadAttr || (Pcb.PadAttr = {}));
    ;
    ...
    })(MODULE_ATTR = Pcb.MODULE_ATTR || (Pcb.MODULE_ATTR = {}));
    ;
    ...
    })(HatchStyle = Pcb.HatchStyle || (Pcb.HatchStyle = {}));
    let PadConnection;
    ...
    })(PadConnection = Pcb.PadConnection || (Pcb.PadConnection = {}));
    let CornerSmoothingType;
    ...
    })(CornerSmoothingType = Pcb.CornerSmoothingType || (Pcb.CornerSmoothingType = {}));
    class Segment {
