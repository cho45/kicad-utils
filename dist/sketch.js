...
}
{
    ...
    //
    const lib = kicad_lib_1.Library.load(fs.readFileSync('tmp/TinyFPGA-A-Programmer-cache.lib', 'utf-8'));
    const sch = kicad_sch_1.Schematic.load(fs.readFileSync('tmp/TinyFPGA-A-Programmer.sch', 'utf-8'));
    console.log(sch);
